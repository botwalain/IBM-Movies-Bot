...
async def start(client:Client, message):
        ...
        try: 
         ...
         #       newPoint = await db.get_point(refUserId)
             if AUTH_CHANNEL and await is_req_subscribed(client, message):
                        ...
                        reply_markup = InlineKeyboardMarkup(buttons)
                        m=await message.reply_sticker("CAACAgUAAxkBAAKEVWcUapHZQnPTQavBESjlJc1VyyNpAALIAwACf9ygVbnPkkqCNVCQNgQ") 
    ...
    if data and data.startswith("allfiles"):
        ...
        delCap = "<b>ᴀʟʟ {} ғɪʟᴇs ᴡɪʟʟ ʙᴇ ᴅᴇʟᴇᴛᴇᴅ ᴀғᴛᴇʀ {} ᴛᴏ ᴀᴠᴏɪᴅ ᴄᴏᴘʏʀɪɢʜᴛ ᴠɪᴏʟᴀᴛɪᴏɴs, ꜱᴏ ᴘʟᴇᴀꜱᴇ ғᴏʀᴡᴀʀᴅ ɪɴ ᴀɴᴏᴛʜᴇʀ ᴄʜᴀᴛ ᴏʀ ʏᴏᴜʀ ꜱᴀᴠᴇᴅ ᴍᴇꜱꜱᴀɢᴇ Aɴᴅ ᴅᴏᴡɴʟᴏᴀᴅ ɪᴛ ᴛʜᴇʀᴇ</b>".format(len(files_to_delete), f'{FILE_AUTO_DEL_TIMER / 60} ᴍɪɴᴜᴛᴇs' if FILE_AUTO_DEL_TIMER >= 60 else f'{FILE_AUTO_DEL_TIMER} sᴇᴄᴏɴᴅs')
        afterDelCap = "<b>ᴀʟʟ {} ғɪʟᴇs ᴀʀᴇ ᴅᴇʟᴇᴛᴇᴅ ᴀғᴛᴇʀ {} ᴛᴏ ᴀᴠᴏɪᴅ ᴄᴏᴘʏʀɪɢʜᴛ ᴠɪᴏʟᴀᴛɪᴏɴs, ꜱᴏ ᴘʟᴇᴀꜱᴇ ғᴏʀᴡᴀʀᴅ ɪɴ ᴀɴᴏᴛʜᴇʀ ᴄʜᴀᴛ ᴏʀ ʏᴏᴜʀ ꜱᴀᴠᴇᴅ ᴍᴇꜱꜱᴀɢᴇ Aɴᴅ ᴅᴏᴡɴʟᴏᴀᴅ ɪᴛ ᴛʜᴇʀᴇ</b>".format(len(files_to_delete), f'{FILE_AUTO_DEL_TIMER / 60} ᴍɪɴᴜᴛᴇs' if FILE_AUTO_DEL_TIMER >= 60 else f'{FILE_AUTO_DEL_TIMER} sᴇᴄᴏɴᴅs')
    ...
    delCap = "<b>Tʜɪꜱ ғɪʟᴇ ᴡɪʟʟ ʙᴇ ᴀᴜᴛᴏᴍᴀᴛɪᴄᴀʟʟʏ ᴅᴇʟᴇᴛᴇᴅ ᴀғᴛᴇʀ {} ᴛᴏ ᴀᴠᴏɪᴅ ᴄᴏᴘʏʀɪɢʜᴛ ᴠɪᴏʟᴀᴛɪᴏɴs, ꜱᴏ ᴘʟᴇᴀꜱᴇ ғᴏʀᴡᴀʀᴅ ɪɴ ᴀɴᴏᴛʜᴇʀ ᴄʜᴀᴛ ᴏʀ ʏᴏᴜʀ ꜱᴀᴠᴇᴅ ᴍᴇꜱꜱᴀɢᴇ Aɴᴅ ᴅᴏᴡɴʟᴏᴀᴅ ɪᴛ ᴛʜᴇʀᴇ</b>".format(f'{FILE_AUTO_DEL_TIMER / 60} ᴍɪɴᴜᴛᴇs' if FILE_AUTO_DEL_TIMER >= 60 else f'{FILE_AUTO_DEL_TIMER} sᴇᴄᴏɴᴅs')
    afterDelCap = "<b>Tʜɪꜱ ғɪʟᴇ ᴡɪʟʟ ʙᴇ ᴀᴜᴛᴏᴍᴀᴛɪᴄᴀʟʟʏ ᴅᴇʟᴇᴛᴇᴅ ᴀғᴛᴇʀ {} ᴛᴏ ᴀᴠᴏɪᴅ ᴄᴏᴘʏʀɪɢʜᴛ ᴠɪᴏʟᴀᴛɪᴏɴs, ꜱᴏ ᴘʟᴇᴀꜱᴇ ғᴏʀᴡᴀʀᴅ ɪɴ ᴀɴᴏᴛʜᴇʀ ᴄʜᴀᴛ ᴏʀ ʏᴏᴜʀ ꜱᴀᴠᴇᴅ ᴍᴇꜱꜱᴀɢᴇ Aɴᴅ ᴅᴏᴡɴʟᴏᴀᴅ ɪᴛ ᴛʜᴇʀᴇ</b>".format(f'{FILE_AUTO_DEL_TIMER / 60} ᴍɪɴᴜᴛᴇs' if FILE_AUTO_DEL_TIMER >= 60 else f'{FILE_AUTO_DEL_TIMER} sᴇᴄᴏɴᴅs') 
    replyed = await message.reply(
        delCap,
...
async def save_tutorial(client, message):
    ...
    try:
        ...
        return await message.reply_text("<b>Command Incomplete!!\n\nuse like this -</b>\n\n<code>/set_caption https://t.me/IBMBotSupport</code>")    
...
async def set_tutorial_2(client, message):
    ...
    try:
        ...
        return await message.reply_text("<b>ᴄᴏᴍᴍᴀɴᴅ ɪɴᴄᴏᴍᴘʟᴇᴛᴇ !!\n\nᴜꜱᴇ ʟɪᴋᴇ ᴛʜɪꜱ -</b>\n\n<code>/set_tutorial_2 https://t.me/xyz/2</code>")
...
async def set_tutorial_3(client, message):
    ...
    try:
        ...
        return await message.reply_text("<b>Command Incomplete!!\n\nuse like this -</b>\n\n<code>/set_tutorial https://t.me/IBMBotSupport</code>")
